  ...
  return (
    <section id="contact" className="section contact-section">
      ...
      >
        ...
        <a href="mailto:stanslauschat@gmail.com" className="contact-card contact-email">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <rect x="2" y="4" width="20" height="16" rx="2" />
            <path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7" />
          </svg>
          stanslauschat@gmail.com
        </a>

        <a href="https://wa.me/254741405165" target="_blank" rel="noopener noreferrer" referrerPolicy="no-referrer" className="contact-card contact-whatsapp">
