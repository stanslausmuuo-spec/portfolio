  ...
  return (
    <section id="contact" className="section contact-section">
      ...
      >
        ...
        <a href="mailto:stanslauschat@gmail.com" className="contact-email">
        ...
        <a href="https://wa.me/254741405165" target="_blank" rel="noopener noreferrer" referrerPolicy="no-referrer" className="contact-email">
